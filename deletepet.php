                    ...
                    <div class="row g-0">
                            <div class="col-4">
                                <div class="card" style="width: 20rem; left: 50px; background: #bb9d85">
                                    ...
                                    <div class="card-body">
                                      <a href="#" class="fs-5 btn "><?php echo $row['name_pet'];?></a>
                                    </div>
                                </div>
                            </div>
                            <div  class="col-8">
                                <div class="card mb-4" style="max-width: 850px; max-height:500px; ">
                                    <div  class="card-body">
                                        <h5 class="card-title">รหัสสัตว์ : <?php echo $row['id_pet'];?></h5>
                                        <p class="card-text">เพศ : <?php echo $row['gender_pet'];?></p>
                                        <p class="card-text">สี : <?php echo $row['color_pet'];?></p>
                                        <p class="card-text">สายพันธุ์ : <?php echo $row['gene_pet'];?></p>
                                        <p class="card-text">วัคซีนที่ได้รับ : <?php echo $row['vac_pet'];?></p>
                                        <p class="card-text">ข้อมูลเพิ่มเติม : <?php echo $row['info_pet'];?></p>                                                                               
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                            ...
                            <div class="col-8">
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <button type="submit" class="btn btn-danger" name = "Post">ลบโพสต์</button>
                                    </div>
                            </div>
                    </div>    
                </div>
